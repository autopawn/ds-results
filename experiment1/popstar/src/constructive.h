...
class PMConstructive {
	private:
		enum {RPG, RGREEDY, PGREEDY, PWORST, PREVERSE, MST, SAMPLE, MIX, RANDOM, INDEP, NMETHODS}; //method types
	...
	public:
		...
		/*---------------------------------------------
		 | constructive algorithms for independent set
		 *--------------------------------------------*/
		static void independent (PMSolution *s, double alpha, bool stats=false);
